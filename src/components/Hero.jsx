...
export default function Hero() {
  return (
    <header id="home" className="relative overflow-hidden">
      <div className="absolute -top-40 -right-32 h-96 w-96 rounded-full blur-3xl opacity-40"
           style={{background:"radial-gradient(closest-side, #CDECE3, transparent)"}}/>
      <div className="absolute -bottom-40 -left-32 h-[28rem] w-[28rem] rounded-full blur-3xl opacity-40"
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center py-16">
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="flex gap-6 pt-2 text-sm text-black/70">
              ...
              <a className="inline-flex items-center gap-2 underline" href={BRAND.igUrl} target="_blank" rel="noreferrer">
                <Instagram className="h-4 w-4"/>{BRAND.ig}
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-6">
            <div className="relative">
              ...
              <div className="aspect-[4/5] w-full overflow-hidden rounded-[2rem] shadow-2xl ring-1 ring-black/5">
                <img
                  src="https://images.unsplash.com/photo-1551524164-687a55dd1126?q=80&w=1600&auto=format&fit=crop"
                  alt="Café lumineux avec personnes qui travaillent"
